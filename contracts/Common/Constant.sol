...
contract Constants {
    ...
    uint256 public constant minimumGoal = (10**18)*(10**8)*3 ; // minimalny cel to 300 000 000 cab coinów, co da 6 000 Eth 
  uint256 public constant maxTokenSupplyPreICO = (10**18)*(10**8)*3 ; 
